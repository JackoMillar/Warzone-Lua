...
function SelectTerritoryClicked()
	...
	TargetTerritoryInstructionLabel.SetText('Please click on the territory you wish to receive the Diplomat unit on. If needed, you can move this dialog out of the way.');
