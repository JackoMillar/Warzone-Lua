...
function showMenu()
	...
	CreateButton(horz).SetText('Credits').SetOnClick(showCredits);
...
function adminMenu()
	Game.SendGameCustomMessage(
		'Gullible Player',
		{
			type = 'UpdatingGullible',
			p = data.Gullible[Game.Us.ID]
		},
...
function showCredits()
	...
	CreateLabel(vert).SetText("Thanks for playing, Hope you aren't too annoyed by the mod :)");
